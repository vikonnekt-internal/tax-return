...
import { Box, Text, GridRow, GridColumn, Button, Divider } from '@island.is/island-ui/core';
...
const StepperResult: React.FC<StepperResultProps> = ({ data, onEdit }) => {
  ...
  return (
    <Box>
      {/* Personal Info */}
      <Box padding={4} background="blue100" borderRadius="large" marginBottom={4}>
        <GridRow>
        ...
        <GridRow>
          ...
          <GridColumn span={['12/12', '6/12', '6/12']}>
            <Box display="flex" justifyContent="flexEnd" height="full">
              <Button variant="ghost" size="small" icon="pencil" iconType="outline" onClick={() => onEdit?.('personal')}>Breyta</Button>
            </Box>
          </GridColumn>
        </GridRow>
      </Box>
      ...
      {/* Revenue Section */}
      <Box marginBottom={4}>
        <Box display="flex" justifyContent="spaceBetween" alignItems="center" marginBottom={2}>
          <Box>
            <Text variant="h3" as="h2">Tekjur ársins 2024</Text>
            <Text>Yfirlit yfir tekjur ársins 2024</Text>
          </Box>
          <Button variant="ghost" size="small" icon="pencil" iconType="outline" onClick={() => onEdit?.('revenue')}>Breyta</Button>
        </Box>
        {/* Income Table */}
        <Box background="blue100" borderRadius="large" padding={2} marginBottom={2}>
          <Text variant="h5" color="blue400" marginBottom={1}>Launatekjur og starfstengdar greiðslur</Text>
          <GridRow>
        ...
        <Box background="blue100" borderRadius="large" padding={2}>
          <Text variant="h5" color="blue400" marginBottom={1}>Ökutækjastyrkur. Dagpeningar. Hlunnindi</Text>
          <GridRow>
            <GridColumn span="8/12">
      ...
      <Box marginBottom={4}>
        <Box display="flex" justifyContent="spaceBetween" alignItems="center" marginBottom={2}>
          <Box>
            <Text variant="h3" as="h2">Eignir ársins 2024</Text>
            <Text>Yfirlit yfir eignir ársins 2024</Text>
          </Box>
          <Button variant="ghost" size="small" icon="pencil" iconType="outline" onClick={() => onEdit?.('assets')}>Breyta</Button>
        </Box>
        {/* Real Estate Table */}
        <Box background="blue100" borderRadius="large" padding={2} marginBottom={2}>
          <Text variant="h5" color="blue400" marginBottom={1}>Fasteignir</Text>
          <GridRow>
            <GridColumn span="4/12">
        ...
        {/* Vehicles Table */}
        <Box background="blue100" borderRadius="large" padding={2}>
          <Text variant="h5" color="blue400" marginBottom={1}>Bifreiðir</Text>
          <GridRow>
            <GridColumn span="4/12">
      ...
      <Box marginBottom={4}>
        <Box display="flex" justifyContent="spaceBetween" alignItems="center" marginBottom={2}>
          <Box>
            <Text variant="h3" as="h2">Vaxtagjöld vegna íbúðarhúsnæðis til eigin nota</Text>
            <Text>Yfirlit yfir skuldir og vaxtagjöld ársins 2024</Text>
          </Box>
          <Button variant="ghost" size="small" icon="pencil" iconType="outline" onClick={() => onEdit?.('interest')}>Breyta</Button>
        </Box>
        {/* Key-value grid for interest expenses */}
        {Array.isArray(interest.interestExpenses) && interest.interestExpenses.map((item: any, idx: number) => (
          <Box key={idx} background="blue100" borderRadius="large" padding={2} marginBottom={2}>
            <GridRow>
      ...
      <Box marginBottom={4}>
        <Box display="flex" justifyContent="spaceBetween" alignItems="center" marginBottom={2}>
          <Box>
            <Text variant="h3" as="h2">Aðrar skuldir og vaxtagjöld</Text>
            <Text>Yfirlit yfir eignir ársins 2024</Text>
          </Box>
          <Button variant="ghost" size="small" icon="pencil" iconType="outline" onClick={() => onEdit?.('debts')}>Breyta</Button>
        </Box>
        <Box background="blue100" borderRadius="large" padding={2}>
          <GridRow>
            <GridColumn span="6/12">
