    ...
    return (
        <StaticLayout
                    ...
                    >
                        ...
                        <Box marginBottom={[3, 3, 3, 12]} marginTop={1}>
                            <Stack space={3}>
                                ...
                                <Text>Einstaklingar geta hér nálgast framtöl sín, skilað inn nýju framtali og skoðað eldri framtöl.</Text>
                            </Stack>
                        </Box>
                    </GridColumn>
                </GridRow>
            ...
            aside={
                ...
                <Box className="flex items-center gap-4" background='purple100' padding={2}>
                    <img src='/assets/iceland.svg' />
                    <div className='flex flex-col'>
                        <div className="flex items-center gap-2">
                            <Text variant="h4"  color='purple600'>Þjónustuaðili</Text>
                            <InfoIcon />
                        </div>
                        <Text variant="h5" color='purple600'>Sýslumaður</Text>
                    </div>
                </Box>
                
                <Box className="flex flex-col" background='blue100'>
                    <Link href={'/'} className="justify-center !text-blue-800 text-xl font-semibold leading-loose border-b border-b-[#CCDFFF] p-4 ">Efnisyfirlit</Link>
                    <Link href={'/'} className="self-stretch justify-start !text-blue-600 text-lg font-semibold px-4 py-6">Skattframtal einstaklinga</Link>
                </Box>
                </div>
            }
        />
